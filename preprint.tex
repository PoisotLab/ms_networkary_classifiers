...
informedness should be used as a maximization criterion.
...
\begin{figure}
\hypertarget{fig:analytics}{%
\centering
\includegraphics{figures/analytics.png}
...
would lead to select a \emph{more} biased
classifier.}\label{fig:analytics}
}
\end{figure}
