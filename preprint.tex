...
\hypertarget{what-are-the-baseline-values-of-thresholding-performance}{%
\subsection{What are the baseline values of thresholding
performance?}\label{what-are-the-baseline-values-of-thresholding-performance}}

ROC-AUC v. PR-AUC, vary \(s\) to simulate a classifier ranging from
no-skill to perfect
