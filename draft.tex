...
(\textbf{Xie2017ComCom?}) - most networks have SBM structure ---
(\textbf{Valdovinos2019MutNet?}) matching + forbidden
(\textbf{Olesen2011MisFor?}), coming up with matching rules that
allow/forbid links can make predictions easier
(\textbf{Strona2017ForPer?}); but valid for most type of interactions as
long as we can match yes/no to numeric predictors
