...
and modularity (REF). The results are presented in
...
three network structure metrics, for the predictions presented in
...
\midrule
\endhead
Decision tree & 0.83 & 0.68 & 0.95 & 0.15 & 0.18 & 0.53 &
\textbf{0.49}\tabularnewline
BRT & 0.76 & 0.89 & 0.95 & 0.65 & 0.22 & 0.63 & 0.43\tabularnewline
Random Forest & \textbf{0.89} & \textbf{0.94} & \textbf{0.99} & 0.41 &
\textbf{0.17} & \textbf{0.48} & \textbf{0.49}\tabularnewline
Ridge Regression & 0.67 & 0.85 & 0.89 & 0.38 & 0.27 & 1.0 &
0.26\tabularnewline
Ensemble & 0.84 & 0.91 & \textbf{0.99} & \textbf{0.94} & 0.19 & 0.54 &
0.48\tabularnewline
Data & & & & & 0.16 & 0.45 & 0.49\tabularnewline
\bottomrule
\end{longtable}
